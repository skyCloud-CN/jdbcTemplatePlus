...
import com.skycloud.fastdao.core.plugins.autofill.AutoFillPlugin;
import com.skycloud.fastdao.core.plugins.columnmap.ColumnMapAnnotationPlugin;
import com.skycloud.fastdao.core.plugins.exclude.ExcludeAnnotationPlugin;
import com.skycloud.fastdao.core.plugins.shard.ShardPlugin;
...
public class PluginManager {
    ...
    private final static Multimap<Class, PluggableHandler> runtimeHandlers = ArrayListMultimap.create();
    ...
    public static void installAllPlugin() {
        boolean isInstall = installed.getAndSet(true);
        if (isInstall) {
            return;
        }
    ...
    public static <T extends Pluggable> T plugin(T pluggable, Class clazz) {
        ...
        if (CollectionUtils.isEmpty(collection)) {
            registerRuntime(pluggable.getClass());
        }
    ...
    private static synchronized void registerRuntime(Class clazz) {
        ...
        runtimeHandlers.putAll(clazz, handlers);
    }
