...
import com.skycloud.fastdao.demo.dao.AutoIncColumnMapPluginDAO;
...
public class AutoIncPluginTest {
    ...
    public void test_update_empty_condition() {
        ...
        Assert.assertTrue(dao.select(new QueryRequest()).stream().map(AutoIncPluginTestModel::getName)
    ...
    private AutoIncPluginTestModel getDefaultModel() {
        ...
        model.setUpdated(new Date().getTime());
