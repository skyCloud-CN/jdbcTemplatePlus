/**
 * @(#)NonAutoIncTest.java, 10月 13, 2019.
 * <p>
...
import io.github.skycloud.fastdao.demo.model.NonAutoIncModel;
...
public class NonAutoIncTest {
    ...
    public void test_select_by_primary_key() {
        NonAutoIncModel model = dao.selectByPrimaryKey(1L);
        log.info(model.toString());
    }

    @Test
    public void test_select_by_primay_key_null() {
        NonAutoIncModel model = dao.selectByPrimaryKey(6L);
        log.info(model.toString());
    }

    @Test
    public void test_select_by_primary_keys() {
        List<NonAutoIncModel> models = dao.selectByPrimaryKeys(Lists.newArrayList(1L, 2L, 3L, 4L, 5L, 6L));
    ...
    public void test_update_by_primary_key() {
        NonAutoIncModel model = getDefaultModel();
        model.setId(6L);
        model.setDeleted(true);
        int count = dao.updateByPrimaryKey(model);
        Assert.assertEquals(1, count);
        NonAutoIncModel fromDB = dao.selectByPrimaryKey(6L);
    ...
    public void test_update_by_primary_key_selective() {
        ...
        Assert.assertEquals(1, count);
        NonAutoIncModel fromDB = dao.selectByPrimaryKey(5L);
    ...
    public void test_insert() {
        ...
        model.setId(10000L);
        dao.insert(model);
        NonAutoIncModel fromDb = dao.selectByPrimaryKey(model.getId());
        assertEqual(model, fromDb);
    }
    ...
    public void test_update_multi_condition() {
        ...
        Assert.assertTrue(dao.selectByPrimaryKeys(1L, 3L).stream().map(NonAutoIncModel::getCreated).allMatch(x -> x.equals(date)));
    }
    ...
    public void test_update_empty_condition() {
        ...
        Assert.assertTrue(dao.select(new DefaultQueryRequest()).stream().map(NonAutoIncModel::getName)
    ...
    public void test_update_ignore_illegal_condition() {
        ...
        Assert.assertTrue(dao.select(new DefaultQueryRequest()).stream()
                .map(NonAutoIncModel::getName).allMatch(x -> x.equals("updated")));
    }
    ...
    private NonAutoIncModel getDefaultModel() {
        NonAutoIncModel model = new NonAutoIncModel();
        model.setName("sky");
        model.setText("cloud");
